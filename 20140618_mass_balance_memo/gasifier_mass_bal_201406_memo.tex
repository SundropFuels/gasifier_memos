...
In order to audit the laboratory gasification system and ensure that our gas analysis data is giving us accurate conversion results, a carbon balance was performed.  100.5\% of the carbon put into the system was accounted for in the gaseous and solid products, and it was determined that the conversion calculations obtained from the mass spec are accurate.
...
The carbon balance was calculated using Equation \ref{eq_balance}, and is a representation of the fraction of carbon in the inlet that is accounted for in all products by solids and gas analyses.  The balance comes out as 1.005, which means that all carbon put into the system was accounted for in the outlet products within 0.5\%.  This is an extremely good result, and it gives great confidence in the ability of the mass spectrometer to provide us with molar flow rates of each gaseous species based on an argon tracer gas.

...
In order to audit the laboratory gasification system and ensure that our gas analysis data is giving us accurate conversion results, a carbon balance was performed.  Samples of the char from the ash knockout and filters were collected and sent off to Huffman Laboratories and TestAmerica.  The carbon balance closed to within 0.5\%, and it was determined that the conversion calculations obtained from the mass spec are accurate.

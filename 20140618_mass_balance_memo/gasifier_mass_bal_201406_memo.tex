...
In order to audit the laboratory gasification system and ensure that our gas analysis data is giving us accurate conversion results, a carbon balance was performed.  Samples of char from the ash knockout and the filters were also collected and sent to Huffman Laboratories for analyses (WHAT ANALYSES?).  \#\#\% of the carbon put into the system was accounted for in the gaseous and solid products, and it was determined that the conversion calculations obtained from the mass spec are accurate.
